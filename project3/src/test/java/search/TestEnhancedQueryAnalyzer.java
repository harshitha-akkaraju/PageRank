...
public class TestEnhancedQueryAnalyzer extends BaseTest {
	...
	private EnhancedQueryAnalyzer makeExampleAnalyzer() {
		...
		return new EnhancedQueryAnalyzer(documents);
	}
	...
	public void testSpecExampleVectorCreation() {
		EnhancedQueryAnalyzer analyzer = this.makeExampleAnalyzer();
		...
		documentAExpected.put("-played", 0.0);
