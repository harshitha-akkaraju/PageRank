...
public class TestPageRankAnalyzer extends BaseTest {
	...
	@Test(timeout=SECOND)
	public void testExample3EachIteration() {
		URI pageAUri = URI.create("http://example.com/page-a.html");
		URI pageBUri = URI.create("http://example.com/page-b.html");
		URI pageCUri = URI.create("http://example.com/page-c.html");
		URI pageDUri = URI.create("http://example.com/page-d.html");
		...
		assertEquals(0.20, analyzer.computePageRank(pageAUri), DELTA);
		assertEquals(0.20, analyzer.computePageRank(pageBUri), DELTA);
		assertEquals(0.20, analyzer.computePageRank(pageCUri), DELTA);
		assertEquals(0.20, analyzer.computePageRank(pageDUri), DELTA);
		assertEquals(0.20, analyzer.computePageRank(pageEUri), DELTA);
	}
	
	@Test(timeout=SECOND)
	public void testExample3SmallEpsilon() {
		URI pageAUri = URI.create("http://example.com/page-a.html");
		URI pageBUri = URI.create("http://example.com/page-b.html");
		URI pageCUri = URI.create("http://example.com/page-c.html");
		URI pageDUri = URI.create("http://example.com/page-d.html");
		...
		PageRankAnalyzer analyzer = new PageRankAnalyzer(pages, 0.4, 0.1, 1);
//		System.out.println(analyzer.computePageRank(pageAUri));
//		System.out.println(analyzer.computePageRank(pageBUri));
//		System.out.println(analyzer.computePageRank(pageCUri));
//		System.out.println(analyzer.computePageRank(pageDUri));
//		System.out.println(analyzer.computePageRank(pageEUri));
	}
	
	@Test(timeout=SECOND)
	public void testExample3DifferentDelta() {
		URI pageAUri = URI.create("http://example.com/page-a.html");
		URI pageBUri = URI.create("http://example.com/page-b.html");
		URI pageCUri = URI.create("http://example.com/page-c.html");
		URI pageDUri = URI.create("http://example.com/page-d.html");
		...
		PageRankAnalyzer analyzer = new PageRankAnalyzer(pages, 0.4, 0.000001, 0);

		assertEquals(0.2, analyzer.computePageRank(pageAUri), 0.00002);
		assertEquals(0.2, analyzer.computePageRank(pageBUri), 0.00002);
		assertEquals(0.2, analyzer.computePageRank(pageCUri), 0.00002);
		assertEquals(0.2, analyzer.computePageRank(pageDUri), 0.00002);
		assertEquals(0.2, analyzer.computePageRank(pageEUri), 0.00002);
	}
	
	@Test(timeout=SECOND)
	public void testExample1EachIteration() {
		URI pageAUri = URI.create("http://example.com/page-a.html");
		URI pageBUri = URI.create("http://example.com/page-b.html");
		URI pageCUri = URI.create("http://example.com/page-c.html");
		URI pageDUri = URI.create("http://example.com/page-d.html");
		...
		PageRankAnalyzer analyzer = new PageRankAnalyzer(pages, 0.85, 0.00001, 0);

		assertEquals(0.25, analyzer.computePageRank(pageAUri), DELTA);
		assertEquals(0.25, analyzer.computePageRank(pageBUri), DELTA);
		assertEquals(0.25, analyzer.computePageRank(pageCUri), DELTA);
		assertEquals(0.25, analyzer.computePageRank(pageDUri), DELTA);
	}
